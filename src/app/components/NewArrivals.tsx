...
export default function NewArrivalsSlider() {
  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto mt-10 select-none">
      <h2 className="text-3xl font-bold mb-6 text-center text-black tracking-wide drop-shadow-lg"style={{ fontFamily: 'Poppins, sans-serif' }}>
        New Arrivals
      </h2>
...
{/* Image ke neeche centered caption */}
